...
commit;
exec update_host_ntn_application_status(2021);
exec update_host_ntn_application_status(2016);
exec update_host_ntn_application_status(2012);
exec update_host_ntn_application_status(2008);
exec update_host_ntn_application_status(2004);
commit;
...
/* Inserting into EVENT_MATCH table */
exec olym_admin_match_inserts(2021);
commit;
...
/* Inserting into GROUP_MATCH_RESULT table */
exec olym_admin_match_result_inserts;
exec olym_admin_generate_res;
commit;
